...
- [Copilot Agent Billing: Credits, Cost Attribution, and Who Actually Pays](https://github.com/heyitsgoad/copilot-playground/blob/main/education%20playground/copilot%20agent%20billing%2C%20credits%20and%20cost%20attribution.md) — An [interactive guide](https://heyitsgoad.github.io/copilot-playground/education%20playground/assets/copilot%20agent%20billing/) for the conversation that starts when an agent shows up on the Azure bill and nobody can explain who caused it. Covers the free versus metered boundary, the full Copilot Credit rate card, the four billing surfaces (Agent Builder, Copilot Studio, Cowork, Foundry) and the scoping difference that breaks most chargeback models, what a resource group really is in billing terms, all three ways to buy credits, which spend controls actually enforce versus only alert, and how to align Azure subscriptions and resource groups to business units. Includes a live decision tool that tells you whether a specific agent will cost anything before you build it, a credit calculator, and a 35-page PDF. Names the three places Microsoft's own documentation contradicts itself instead of guessing, and flags the November 1, 2026 AI Builder credit removal.
